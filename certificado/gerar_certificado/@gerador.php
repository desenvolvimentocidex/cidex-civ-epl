...
$texto5 = utf8_decode("Rio de Janeiro, RJ, ".utf8_encode(strftime( '%d de %B de %Y', strtotime( date( 'Y-m-d' ) ) )).".");
$texto6 = utf8_decode("JOSÉ AUGUSTO PEREIRA DA COSTA - Ten Cel");
$texto7 = utf8_decode("Chefe da Divisão de Certificação                       ");
$texto8 = utf8_decode("MAURÍCIO AVELAR TINOCO - Cel");
...
$pdf->Image('cel-tinoco2.png',163,150,120,40);
// opacidade total
$pdf->SetAlpha(1);
...
$pdf->SetFont('Arial', 'B', 13); // Tipo de fonte e tamanho
$pdf->SetTextColor(0,0,0); //Cor em RGB
$pdf->SetXY(190,170); //Ajustando a posição X e Y
$pdf->MultiCell(265, 10, $texto8, '', 'L', 0); // Tamanho width e height e posição

// Mostrar a data no final
$pdf->SetFont('Arial', '', 13); // Tipo de fonte e tamanho
$pdf->SetTextColor(0,0,0); //Cor em RGB
$pdf->SetXY(171,176); //Ajustando a posição X e Y
...
$texto32 = utf8_decode("Para verificar a validade deste documento, acesse http://www.portaldeeducacao.eb.mil.br/cidex/validacao/ e insira o código localizado na parte inferior da frente do certificado.");
