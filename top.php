	...
	<div id="top_content">
		...
		<div id="top_down">
			<div id="top_down_left">
				<div id="logo"></div>
				<div id="logo_text">Ministério da Defesa - Departamento de Educação e Cultura do Exército</br>
                                    <h1><a style="font-size: 40px !important" href="index.php">Centro de Idiomas do Exército</a></h1>
                                    <div style="text-transform: uppercase">DIRETORIA DE EDUCAÇÃO TÉCNICA MILITAR</div>
                                </div>
			</div>
...
<div id="top_menu">
	<div id="top_menu_link">
                <a href="validacao/" >Validação de Certificado</a> |
